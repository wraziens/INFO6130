...
public class DailySurveySleep extends Activity implements OnClickListener,OnCheckedChangeListener{
	...
	String sleepResult,coffeeResult;
	...
	public void onCheckedChanged(RadioGroup group, int checkedId) {
		...
		switch(group.getId()){
			case R.id.rgDSSleep1:
				sleepResult=((RadioButton)findViewById(checkedId)).getText().toString();
				break;
			case R.id.rgDSSleep2:
				coffeeResult=((RadioButton)findViewById(checkedId)).getText().toString();
				break;
		}
	}
