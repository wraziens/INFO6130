...
public class ProductivityVisualizationTutorial extends Activity implements OnCheckedChangeListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.productivityvisualizationtutorial);
		hint=(CheckBox)findViewById(R.id.cbProductivityVisualizationTutorial);
		hint.setOnCheckedChangeListener(this);
	}
	@Override
	public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
		// TODO Auto-generated method stub
		if (buttonView.getId()==R.id.cbProductivityVisualizationTutorial){
