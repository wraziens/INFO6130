...
public class DrinkCalendarTutorial extends Activity implements OnCheckedChangeListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.drinkcalendartutorial);
		hint=(CheckBox)findViewById(R.id.cbDrinkCalendarTutorial);
		hint.setOnCheckedChangeListener(this);
	}
	@Override
	public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
		// TODO Auto-generated method stub
		if (buttonView.getId()==R.id.cbDrinkCalendarTutorial){
